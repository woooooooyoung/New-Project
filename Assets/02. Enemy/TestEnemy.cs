...
public class TestEnemy : MonoBehaviour
{
    ...
    IEnumerator Idle()
    {
        ...
        if (curAnimStateInfo.IsName("Sword And Shield Idle") == false)
            animator.Play("Sword And Shield Idle", 0, 0);
    ...
    IEnumerator Chase()
    {
        ...
        if (curAnimStateInfo.IsName("Sword And Shield Run") == false)
        {
            animator.Play("Sword And Shield Run", 0, 0);
